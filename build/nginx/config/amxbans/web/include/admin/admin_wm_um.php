...
require_once('include/config.inc.php'); // Make sure this file sets up the $mysql variable

//change menu position function
function menu_change_pos($mid, $pos, $pos_new, $mysql) {
    global $config;
...
if((isset($_POST["pos_up_x"]) || isset($_POST["pos_dn_x"]))  && $_SESSION["loggedin"]) {
    ...
    menu_change_pos($mid, $pos, $pos_new, $mysql);
...
if(isset($_POST["save"]) && $_SESSION["loggedin"]) {
        ...
        if(!(isset($_POST["mid"]))) {
            menu_change_pos($mid, (int)$_POST["pos"], (int)$_POST["pos_new"], $mysql);
        }
