                    ...
                    <table width="100%" class="table_details" border="1">
                        <form method="post">
                            ...
                            <tr>
                                ...
                                <td><input type="text" size="30" name="name" value="{$comment.name|default:"N/A"}" /></td>
                            </tr>
                            <tr>
                                <td align="right" width="30%"><i><b>{"_EMAIL"|lang}:</b></i></td>
                                <td><input type="text" size="30" name="email" value="{$comment.email|default:"N/A"}" /></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    {/foreach}
                                    <br />
                                    <textarea name="comment" id="commentce{$comment.id}" cols="50" rows="3" wrap="soft">{$comment.comment|default:""}</textarea>
                                    <br />
